	...
	<form id="form-create-discount" onsubmit="return false;">
		<div class="row">
			<div class="col-6">
				<div class="form-group">
					...
					<input type="text" value="" name="name" class="form-control" placeholder="{{trans('Location'.DS.'user.discount_name')}}">
				</div>
				<!-- end form-group -->
			</div>
			<div class="col-6">
				<div class="form-group">
					...
					<input type="text" value="" maxlength="20" name="slogan" class="form-control" placeholder="{{trans('Location'.DS.'user.discount_text')}}">
				</div>
				<!-- end form-group -->
			</div>
			<div class="col-6">
				<div class="form-group">
					...
					<select  name="type" class="custom-select form-control">
						<option value="cua_hang">{{trans('Location'.DS.'user.discount_store')}}</option>
						<option value="online">{{trans('Location'.DS.'user.discount_online')}}</option>
						<option value="tong_hop">{{trans('Location'.DS.'user.discount_general')}}</option>
					</select>
				</div>
				<!-- end form-group -->
			</div>
			...
			<div class="col-md-12">
				<div class="form-group">
					...
					<textarea class="form-control" id="discount_description" rows="5"  name="description" placeholder="{{trans('Location'.DS.'user.discount_require')}} <span class="text-danger">*</span>"></textarea>
				</div>
				<!-- end form-group -->
			</div>
			<div class="col-6">
				<div class="form-group">
					...
					<input type="text" value="" name="discount_from" class="choose_date form-control discount_from" placeholder="{{trans('Location'.DS.'user.discount_from')}}">
				</div>
				<!-- end form-group -->
			</div>
			<div class="col-6">
				<div class="form-group">
					...
					<input type="text" value="" name="discount_to" class="choose_date form-control discount_to" placeholder="{{trans('Location'.DS.'user.discount_to')}}">
				</div>
				<!-- end form-group -->
			</div>
			<div class="col-12">
        ...
        <label class="custom-control custom-radio">
          ...
          <span class="custom-control-indicator"></span>
				...
				<div class="upload-placeholder"  id="discount_image_upload" style="">
          <div class="upload-img-post" id="create_discount_image">
			...
			<div class="col-md-12 text-center">
				<button type="button" onclick="createDiscount()" class="btn-submit btn btn-primary">{{trans('Location'.DS.'user.create_discount')}}</button>
				<!-- end form-group -->
			</div>
			<!-- <div class="col-md-12">
