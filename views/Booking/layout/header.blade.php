              ...
              <img src="/frontend/assets/img/logo/Logo.svg" alt="">
					...
					<div class="search-header form-search">
						<form onsubmit="return false;">
							<input style ="padding-left:35px;" id="project" class="form-control w-100" onkeyup="suggestSearch(this)" type="" name="keyword" value="" placeholder="{{trans('global.keyword')}} …">
					...
					<div class="header-right d-flex justify-content-between">
							...
							<div class="notification-content">
									<ul class="nav" role="tablist">
											<li class="nav-item">
													<a class="nav-link active" data-toggle="tab" href="#news" role="tab">News ({{$count_news}})</a>
											</li>
											@if (Auth::guard('web_client')->user())
											<li class="nav-item">
													<a class="nav-link" data-toggle="tab" href="#notification" role="tab" onclick="readNotifi({{Auth::guard('web_client')->user()->id}})">Notification ({{$count_notifications}})</a>
											</li>
											@endif
									</ul>
									<!-- Tab panes -->
							...
							<div class="signin-url">
								...
								<div class="box-profile">
									...
									<ul class="group-profile-sub group-nav list-unstyled p-3">
										...
										<li>
											<a href="{{route('logoutClient')}}" title="">{{trans('global.logout')}}</a>
										</li>
									</ul>
								</div>
								@endif
...
<div class="notification-mobile">
	<a class="come-back" href="" title="">
			<i class="icon-left-1"></i> Trở về
	</a>
	<div class="notification-content">
			<ul class="nav" role="tablist">
					<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#news_mobile" role="tab">News ({{$count_news}})</a>
					</li>
					@if (Auth::guard('web_client')->user())
					<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#notification_mobile" role="tab" onclick="readNotifi({{Auth::guard('web_client')->user()->id}})">Notification ({{$count_notifications}})</a>
					</li>
					@endif
			</ul>
			<!-- Tab panes -->
