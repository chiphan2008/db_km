					...
					<div class="contact-box-form">
						<form class="form-contact" method="post" action="">
							...
							<div class="form-group">
								<input type="text" class="form-control" name="name" placeholder="Họ tên" value="{{Auth::guard('web_client')->user() ? Auth::guard('web_client')->user()->full_name : ''}}" required>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input type="tel" class="form-control" name="phone" placeholder="Số điện thoại" value="{{Auth::guard('web_client')->user() ? Auth::guard('web_client')->user()->phone : ''}}" required>
							</div>
							<div class="form-group">
