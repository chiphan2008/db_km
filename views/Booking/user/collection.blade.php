            ...
            @endif
              ...
              <div class="dropdown-action-gallery dropdown ">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                  @if(Auth::guard('web_client')->user() && Auth::guard('web_client')->user()->id == $user->id)
                    <a class="dropdown-item btn-collection-edit" href="#">{{trans('global.edit')}}</a>
...
<div id="modal-submit-remove" class="modal fade modal-submit-payment  modal-vertical-middle modal-report" tabindex="-1" role="dialog" aria-labelledby="modal-submit-payment" aria-hidden="true">
...
<div id="modal-submit-delete" class="modal fade modal-submit-payment  modal-vertical-middle modal-report" tabindex="-1" role="dialog" aria-labelledby="modal-submit-payment" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content text-center">
      <div class="modal-logo pt-4 text-center">
        <img src="/frontend/assets/img/logo/logo-large.svg" alt="">
