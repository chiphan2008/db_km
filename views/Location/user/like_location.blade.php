				...
				<li class="col-lg-4 col-6" id="item_{{$content->id}}">
					<div class="card-vertical card">
						<div class="card-img-top">
							...
							<div class="dropdown">
								<a class="btn btn-secondary" href="#" data-toggle="modal" data-target="#modal-submit-payment" class="dropdown-item" href="" onclick="modalLikeContent({{$content->id}},{{Auth::guard('web_client')->user()->id}},'{{$content->name}}')">
...
@section('JS')
	...
	@endif
	<script>
	 function modalLikeContent(id_content, id_user,name){
