		...
		<div class="row">
			...
			<div class="col-6">
				<div class="form-group">
					...
					<input type="text" value="{{$discount->slogan}}" name="slogan" class="form-control" placeholder="{{trans('Location'.DS.'user.discount_text')}}">
				</div>
			</div>
            ...
            <option value="other" {{$discount->type=='other'?'selected':''}}>{{trans('Admin'.DS.'discount.other')}}</option>
				...
				<div class="form-group row">
					<div class="from_percent col-4" style="display: none;">
          ...
          <div class="from_price col-4" style="display: none;">
            <div class="input-group">
              <input value="{{$discount->from_price}}" name="from_price" type="number" class="form-control" placeholder="" aria-describedby="basic-addon1">
            </div>
          </div>
          <div class="split col-1 text-center" style="display: none;">
                  -
          </div>
          <div class="to_percent col-4" style="display: none;">
            <div class="input-group">
          ...
          <div class="other col-12" style="display: none;">
            <div class="row">
			...
			<div class="col-md-12">
				<div class="form-group">
					...
					<textarea class="form-control" id="discount_description" rows="5"  name="description" placeholder="{{trans('Location'.DS.'user.discount_require')}}">{!! $discount->description !!}</textarea>
				</div>
			</div>
			<div class="col-6">
				<div class="form-group">
