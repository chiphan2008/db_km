  ...
  <div class="content-location-detail content-page">
        ...
        <div class="content">
          ...
          <div class="d-md-flex justify-content-md-between align-items-md-start row">
            <ol class="info-contact list-unstyled my-3 mb-lg-0 col-md-7 col-lg-7">
              ...
              <!-- <li><button class="btn btn-primary" href="#"><i class="icon-commenting-o"></i>Chat Online</button></li> -->
              <li><i class="icon-time"></i>{{ $open_time }}</li>
              <li>{{$content->description?$content->description:trans('global.content_is_update')}}</li>
            ...
            <div class="box-right col-md-5 col-lg-4">
              <div class="meta-post d-flex align-items-center hidden-lg-up">
                <div class="add-like d-flex align-items-center">
                  <i class="{{isset($like_point) ? 'icon-heart' : 'icon-heart-empty' }}"
                     onclick="getLikeContent({{$content->id}},{{ isset(Auth::guard('web_client')->user()->id)?Auth::guard('web_client')->user()->id:'' }})"></i>
                  <span class="point_like">&nbsp;&nbsp;({{$content->like}})</span>
              ...
              <div class="flex-lg-last my-3 mb-lg-0 checkin-block align-items-md-end">
                <ul class="list-group-pd list-unstyled">
                  ...
                  <li><a
                      ...
                      id="save_like_content_total">{{$content->save_like_content>0?$content->save_like_content:0}}</span></li>
                  <li>
                      <div class="dropdown-collection">
                          ...
                          {!!'onclick="showDropdownCollection(this);"'!!}
                          @else
                          {!!'onclick="showLogin();"'!!}
                          @endif
   ...
   {{-- @if(count($image_space) > 0 || count($image_menu) > 0 || count($link_video) > 0) --}}
                ...
                @foreach($link_video as $value)
                  @if (strpos($value,'facebook.com') == TRUE)
                    <li class="iframe-video">
                      ...
                      <iframe width="179" height="155" src="https://www.facebook.com/plugins/video.php?height=464&href={{$value}}" frameborder="0" allowfullscreen style="background-color: #1d2129;"></iframe>
                    </li>
    ...
    <section class="my-4 my-md-5">
      <div class="container">
        <div class="row">
          <!-- <div class="col-lg-4 flex-lg-last mb-3 mb-lg-0 hidden-md-up">
            <ul class="list-group-pd list-unstyled">
              <li><a class="cursor" id="checkin"
                     onclick="checkinContent({{$content->id}},{{ isset(Auth::guard('web_client')->user()->id)?Auth::guard('web_client')->user()->id:'' }})">Check
                  in </a><span id="checkin_total">{{$content->checkin}}</span></li>
