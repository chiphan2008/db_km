				...
				<div class="container d-lg-flex justify-lg-content-between">
                    ...
                    {{trans('Location'.DS.'content.distance')}} <b><span class="distance"></span></b>
								...
								<li>
									...
									<a class="cursor" id="checkin" onclick="checkinContent({{$content->id}},{{ isset(Auth::guard('web_client')->user()->id)?Auth::guard('web_client')->user()->id:'' }})">Check in 
									</a>
									(<span class="checkin_total">{{$content->checkin}}</span>)
								</li>
								<li>
									<span><i class="icon-target"></i></span>
									<a onclick="saveLikeContent({{$content->id}},{{ isset(Auth::guard('web_client')->user()->id)?Auth::guard('web_client')->user()->id:'' }})" class="cursor">
											...
											<div class="dropdown-menu-collection dropdown-menu  p-3 pr-4">
													...
													<form action="" class="form-create-gallery ">
															<div class="form-inline row">
																	...
																	<button type="button" onclick="newCollection(1)" class="btn btn-primary col-sm-3"><i class="icon-new-white"></i></button>
															</div>
															<!-- end  form inline -->
														<div class="">
															@if($collections)
