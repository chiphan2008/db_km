...
<div id="wrapper">
  <div class="box-wrapper">
    <!-- /header -->
    <div class="bg-gray">
      <div class="modal-dialog my-0 py-5" style="max-width: 50%">
        <!-- modal-header -->
        ...
        <div class="modal-body">
          <h3 class="title-form mr-0 text-uppercase text-center mb-3">{{trans('Location'.DS.'layout.active_account')}}</h3>
          <form class="form-sin" method="" action="">
