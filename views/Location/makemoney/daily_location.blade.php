<div class="content-edit-profile-manager">
	<div class="row mb-3">
		<div class="col-md-4 col-xs-12">
			<h3>
				{{mb_strtoupper(trans('Location'.DS.'makemoney.count_location'))}} (<t id="save_like_content_total">{{$count_location}}</t>)
			</h3>
		</div>
		<div class="col-md-4 col-xs-12">
	...
	<div class="list-content-profile">
		<ul class="row list-unstyled">
				...
				<li class="col-lg-4 col-6" id="item_{{$content->id}}">
					<div class="card-vertical card">
						...
						<div class="card-block py-2 px-0">
							...
							@else
							<div class="d-flex align-items-center">
								<a href="{{route('info_location',['id'=>$content->id])}}" class="btn btn-secondary">{{trans('Location'.DS.'makemoney.ctv_info')}}</a>
							</div>
							@endif
						</div>
					</div>
			...
			@endforeach
			@else
			<li class="col-12"><h5 class="text_no">{{trans('Location'.DS.'makemoney.no_location')}}</h5></li>
			@endif
		</ul>
		@if($contents)
		<div class="col-sm-12">
