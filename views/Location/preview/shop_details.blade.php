          ...
          @if(count($image_space) > 0)
            <div class="box-gallery">
              <div class="title-gallery d-flex justify-content-between align-items-start">
                <h4 class="text-uppercase mb-3">{{trans('Location'.DS.'preview.space')}} ({{count($image_space)}})</h4>
          ...
          <div class="col-lg-4 flex-lg-last mb-3 mb-lg-0">
            <ul class="list-group-pd list-unstyled">
              ...
              <li><a
                  ...
                  class="cursor">{{trans('Location'.DS.'preview.save_favorites')}}</a> <span
          ...
          <div class="container">
            <div class="box-gallery mb-4">
              <div class="title-gallery">
                <h4 class="text-uppercase mb-3">{{trans('Location'.DS.'preview.other_branch')}}</h4>
              </div>
