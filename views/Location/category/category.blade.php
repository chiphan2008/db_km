<div class="banner-fill banner-page banner text-center" style="background-image: url({{$category->background?$category->background:''}});">
	<div class="container">
			<div class="main-banner">
					...
					<ol class="breadcrumb text-center hidden-xs-down align-items-center">
...
<script type="text/javascript">
	...
	if(!sessionStorage.page){
		sessionStorage.page = JSON.stringify([]);
	}
	$(function(){
		...
		old_page = pageObj.page?pageObj.page:0;
		old_url = pageObj.url?pageObj.url:current_url;
		...
		if(old_page>1 && old_url==current_url){
			...
			setTimeout(function(){
				old_page = 0;
				sessionStorage.page = JSON.stringify({page:old_page,url:old_url});
			},1000*old_page)
		}
	})
	...
	$(function(){
		if($(window).width()<768){
			$('.breadcrumb-mobile ol').height($(window).height() - 265)
			$('.breadcrumb-mobile ol').css({
				'overflow-y':'scroll',
			})
		}
