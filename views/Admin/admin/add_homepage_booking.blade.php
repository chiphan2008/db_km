...
@section('content')
  ...
  @endif
  <form class="form-horizontal form-label-left" method="post" action="{{route('add_home_booking')}}" enctype="multipart/form-data">
    {{ csrf_field() }}
    @if ($errors->has('error'))
    ...
    <div class="form-group">
      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
        <button type="submit" class="btn btn-success">{{trans('Admin'.DS.'home_booking'.DS.'add.add')}}</button>
      </div>
    </div>
  </form>
@endsection
