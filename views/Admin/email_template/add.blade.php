...
@section('content')
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Form Create Email Template </h2>
        ...
        <div class="x_content">
          <br>
          <form id="#demo-form22" method="post" action="{{route('add_email')}}" data-parsley-validate=""
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <textarea type="text" id="body" name="body" rows="20"
                          class="form-control col-md-7 col-xs-12" >{{ old('body') }}</textarea>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="submit"
                        class="btn btn-success">{{trans('Admin'.DS.'email_template.add_email_template')}}</button>
              </div>
            </div>
