    ...
    <div class="row">
      ...
      <div class="col-sm-12" style="min-height:500px">
        ...
        <ul class="nav nav-tabs">
          <li class="{{isset($moderation)&&$moderation =='all'?'active':''}}"><a href="{{route('list_content_user',['id'=>$user->id,'moderation'=>'all'])}}">{{trans('global.all')}}</a></li>
          <li class="{{isset($moderation)&&$moderation =='in_progress'?'active':''}}"><a href="{{route('list_content_user',['id'=>$user->id,'moderation'=>'in_progress'])}}">{{trans('Admin'.DS.'page_user.in_progress')}}</a></li>
          <li class="{{isset($moderation)&&$moderation =='request_publish'?'active':''}}"><a href="{{route('list_content_user',['id'=>$user->id,'moderation'=>'request_publish'])}}">{{trans('Admin'.DS.'page_user.request_publish')}}</a></li>
          <li class="{{isset($moderation)&&$moderation =='reject_publish'?'active':''}}"><a href="{{route('list_content_user',['id'=>$user->id,'moderation'=>'reject_publish'])}}">{{trans('Admin'.DS.'page_user.reject_publish')}}</a></li>
          <li class="{{isset($moderation)&&$moderation =='publish'?'active':''}}"><a href="{{route('list_content_user',['id'=>$user->id,'moderation'=>'publish'])}}">{{trans('Admin'.DS.'page_user.publish')}}</a></li>
          <li class="{{isset($moderation)&&$moderation =='trash'?'active':''}}"><a href="{{route('list_content_user',['id'=>$user->id,'moderation'=>'trash'])}}">{{trans('Admin'.DS.'page_user.trash')}}</a></li>
        </ul>

        <div class="x_panel">
          <form class="form-horizontal form-label-left search_group row" method="get" action="#">
            ...
            <div class="form-group item">
              <label class="control-label col-md-3 col-sm-3 col-xs-12">{{trans('global.from')}}</label>
              <div class="col-md-9 col-sm-9 col-xs-12">
            ...
            <div class="form-group item">
              <label class="control-label col-md-3 col-sm-3 col-xs-12">{{trans('global.to')}}</label>
              <div class="col-md-9 col-sm-9 col-xs-12">
