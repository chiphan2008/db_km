...
@section('content')
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Form Create Template Notifi </h2>
        ...
        <div class="x_content">
            ...
            @endif
          <br>
          <form id="#demo-form22" method="post" action="{{route('add_template_notifi')}}" data-parsley-validate=""
            ...
            <div class="form-group">
              <div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-3">
                <button type="submit"
                        class="btn btn-success">{{trans('Admin'.DS.'template_notifi.add_template_notifi')}}</button>
              </div>
            </div>
