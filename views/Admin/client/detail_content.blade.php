        ...
        <div class="x_panel">
          <form class="form-horizontal form-label-left" method="post" action="#">
            ...
            <div class="form-group">
              @if($type == 'content')
                {{trans('Admin'.DS.'client.client')}} {{$client->full_name}} {{trans('Admin'.DS.'client.created_total')}} {{$content_of_client->total()}} {{trans('Admin'.DS.'client.posts')}}.
              @elseif($type == 'like')
                {{trans('Admin'.DS.'client.client')}} {{$client->full_name}} {{trans('Admin'.DS.'client.liked_total')}} {{$content_of_client->total()}} {{trans('Admin'.DS.'client.posts')}}.
              @elseif($type == 'vote')
                {{trans('Admin'.DS.'client.client')}} {{$client->full_name}} {{trans('Admin'.DS.'client.voted_total')}} {{$content_of_client->total()}} {{trans('Admin'.DS.'client.posts')}}.
              @endif
            </div>
          </form>
        </div>
