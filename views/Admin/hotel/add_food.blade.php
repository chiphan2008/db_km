      ...
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          <form id="form-content" method="post" onsubmit="checkLinkIsVideo()" action="{{route('add_food_content')}}" enctype="multipart/form-data"
            ...
            <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="image_menu">{{trans('Admin'.DS.'hotel.image_menu')}}
              </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12"></label>
              <div class="col-md-6 col-sm-6 col-xs-12" id="list_image_menu">
              </div>
            </div>
{{--//////////////////////////////////////////////////--}}
