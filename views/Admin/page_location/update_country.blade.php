          ...
          <form id="#demo-form22" method="post" action="" data-parsley-validate=""
            ...
            <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12"
                     for="full_name">{{trans('Admin'.DS.'page_location.country_name')}}
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="zipcode" name="zipcode"
                       class="form-control col-md-7 col-xs-12 {{$errors->has('zipcode')?'parsley-error':''}}"
                       value="{{ $country->zipcode }}">
                @if ($errors->has('zipcode'))
                  <ul class="parsley-errors-list filled">
                    <li class="parsley-required">{{ $errors->first('zipcode') }}</li>
                  </ul>
                @endif
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="submit"
                        class="btn btn-success">{{trans('Admin'.DS.'page_location.update_country')}}</button>
              </div>
            </div>
