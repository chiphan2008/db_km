  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          <br>
          <form id="#demo-form22" method="post" action="{{route('add_service_item')}}" data-parsley-validate=""
            ...
            <div class="form-group">
              <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="submit"
                        class="btn btn-success">{{trans('Admin'.DS.'service_item.add_service_item')}}</button>
              </div>
            </div>
          </form>
        </div>
