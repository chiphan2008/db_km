  ...
  <div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
    <div class="row">
      ...
      <div class="pull-right" style="margin-right: 15px;">
        ...
        <a href="{{route('list_service_item')}}" style="float: right"
           class="btn btn-success">{{trans('global.list')}}</a>
      </div>
              ...
              <tr role="row" class="odd">
                ...
                <td>
                  @if(Auth::guard('web')->user()->can('edit_ServiceItem'))
                    ...
                    / <a href="{{route('approve_service_item', ['id' => $service_item->id])}}">{{trans('global.approve')}}</a>
                  @endif
                </td>
              </tr>
            @endforeach
