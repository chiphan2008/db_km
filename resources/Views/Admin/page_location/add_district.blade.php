...
@section('content')
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Form Create District </h2>
          <ul class="nav navbar-right panel_toolbox">
            <a href="{{route('list_district',['id' => $city_id])}}" style="float: right" class="btn btn-primary">{{trans('global.back')}}</a>
          </ul>
          <div class="clearfix"></div>
        </div>
        <div class="x_content">
          <br>
          <form id="form-add-district" method="post" action="" data-parsley-validate=""
            ...
            <div class="form-group">
              <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="submit" class="btn btn-success">{{trans('Admin'.DS.'page_location.add_district')}}</button>
              </div>
            </div>
