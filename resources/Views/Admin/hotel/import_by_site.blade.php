              ...
              <div class="form-group">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                  <select class="form-control" name="id_category" id="id_category" onchange="getCategoryAjax(this.value,'category_item')" >
                    <option value="">-- {{trans('Admin'.DS.'hotel.category')}} --</option>
                ...
                <div class="col-md-5 col-sm-5 col-xs-12">
                  <div class="imgupload panel panel-default">
                    <div class="panel-heading clearfix">
                      <h3 class="panel-title pull-left">{{trans('Admin'.DS.'hotel.upload_image')}}</h3>
                    </div>
                    <div class="file-tab panel-body">
                      <div>
                        <a type="button" class="btn btn-default btn-file">
                          <span>{{trans('Admin'.DS.'hotel.browse')}}</span>
