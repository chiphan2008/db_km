  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          <br/>
          <form id="form-content" method="post" action="{{route('add_bank_content')}}" enctype="multipart/form-data"
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <select class="form-control" name="category_item[]" id="category_item" >
                  <option value="">-- {{trans('Admin'.DS.'hotel.cat_item')}} --</option>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                BANK <input type="checkbox" class="js-switch"
                            {{ old('active') == '1' ? 'checked' : '' }} name="bank_type"> ATM
              </div>
            </div>
