...
@section('content')
  ...
  <form class="form-horizontal form-label-left" method="post" action="{{route('add_type')}}" enctype="multipart/form-data">
    {{ csrf_field() }}
    @if ($errors->has('error'))
    ...
    <div class="form-group">
      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
        <button type="submit" class="btn btn-success">{{trans('Admin'.DS.'type.add_type')}}</button>
      </div>
    </div>
  </form>
@endsection
