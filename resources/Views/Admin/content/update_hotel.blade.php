              ...
              @if($data['id_category'] != '11')
                {{--<div class="form-group">--}}
                  ...
                  {{--<div class="col-md-3 col-sm-3 col-xs-12 location-div">--}}
                    {{--<input type="number" id="price_from" required name="price_from" onchange="min_number_price()"--}}
                  ...
                  {{--</div>--}}
                  {{--<div class="col-md-3 col-sm-3 col-xs-12 location-div">--}}
                    {{--<input type="number" id="price_to" required name="price_to" onchange="max_number_price()"--}}
