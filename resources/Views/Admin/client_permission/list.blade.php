  ...
  <div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
    <div class="row">
      ...
      <div class="pull-right" style="margin-right: 15px;">
        <a href="{{route('add_client_permission')}}" style="float: right" class="btn btn-primary">{{trans('Admin'.DS.'permission.add_permission')}}</a>
      </div>
      @endif
            ...
            @foreach ($list_permission as $permission)
              <tr role="row" class="odd">
                ...
                <td>
                  ...
                  <a href="{{route('update_client_permission', ['id' => $permission->id])}}">{{trans('global.edit')}}</a>
                  @endif
  ...
  <script type="text/javascript">
    ...
    function deletePermission(id) {
      if( confirm('{{trans('Admin'.DS.'permission.confirm_delete')}}') ) {
        window.location = '/admin/client_permission/delete/'+id
      }
    }
  </script>
@endsection
