...
@section('content')
  ...
  <form class="form-horizontal form-label-left" method="post" action="{{route('add_client_group')}}" enctype="multipart/form-data">
    {{ csrf_field() }}
    @if ($errors->has('error'))
    ...
    <div class="form-group">
      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
        <button type="submit" class="btn btn-success">{{trans('Admin'.DS.'role.add_group')}}</button>
      </div>
    </div>
  </form>
@endsection
